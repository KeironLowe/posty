...
class RepositoryTest extends PostyTestCase
{
    ...
    /** @test */
    public function it_,can_get_item_at_index(): void
    {
        $repository = new class extends Repository {};
        $repository->items = [1, 2, 3, 4, 5];
    ...
    /** @test */
    public function it_,can_set_item_at_index(): void
    {
        $repository = new class extends Repository {};
    ...
    /** @test */
    public function it_,can_set_item_without_an_index(): void
    {
        $repository = new class extends Repository {};
        $repository->items = [1, 2, 3, 4, 5];
    ...
    /** @test */
    public function it_,can_remove_item_at_index(): void
    {
        $repository = new class extends Repository {};
        $repository->items = [1, 2, 3, 4, 5];
